var store = [{
        "title": "Post: Gallery",
        "excerpt":"These are gallery tests for image wrapped in &lt;figure&gt; elements. To place a gallery add the necessary YAML Front Matter: gallery: - url: /assets/images/unsplash-gallery-image-1.jpg image_path: /assets/images/unsplash-gallery-image-1-th.jpg alt: \"placeholder image 1\" title: \"Image 1 title caption\" - url: /assets/images/unsplash-gallery-image-2.jpg image_path: /assets/images/unsplash-gallery-image-2-th.jpg alt: \"placeholder image 2\" title: \"Image 2 title caption\" -...","categories": ["Sample"],
        "tags": ["gallery","Post Formats","tiled"],
        "url": "http://localhost:4000/sample/2010/09/09/post-gallery.html",
        "teaser": null
      },{
        "title": "Example Project",
        "excerpt":"H1 Heading H2 Heading H3 Heading Here’s some basic text. And here’s some italics Here’s some bold text. What about a link? Here’s a bulleted list: First item Second item Third item Here’s a numbered list: First Second Third Python code block: import numpy as np def test_function(x, y): z...","categories": ["Sample"],
        "tags": ["data wrangling","data science","messy data"],
        "url": "http://localhost:4000/sample/2018/01/28/Sample.html",
        "teaser": null
      },{
        "title": "US 2016 Election Analysis",
        "excerpt":"Background Discussion What makes predicting voter behavior (and thus election forecasting) a hard problem? Many reasons may lead to the difficulty of predicting the voter behavior and election forecasting. The first one may be the number of voters for the 2016’s polls. While we expect that the equal number of...","categories": ["project"],
        "tags": ["data wrangling","data visualization","prediction","R"],
        "url": "http://localhost:4000/project/2018/06/11/Election.html",
        "teaser": null
      },{
        "title": "Auto Chess in Dota 2",
        "excerpt":"This is a video uploaded by myself that playing Auto Chess a year ago. It is a really fun game to play and require some unique strategies in order to win against 7 other players. Enjoy the video.     ","categories": ["life"],
        "tags": ["bilibili","autochess"],
        "url": "http://localhost:4000/life/2020/02/20/Autochess.html",
        "teaser": null
      },{
        ...
        "url": "http://localhost:4000/sample/2020/02/20/Lightest-laptop.html",
        "teaser": null
      },{
        ...
        "tags": ["Personal"],
        "url": "http://localhost:4000/life/2020/02/24/Firstpost.html",
        "teaser": null
      },{
        ...
        "tags": [],
        "url": "http://localhost:4000/jekyll/update/2020/10/14/welcome-to-jekyll.html",
        "teaser": null
      }]
